...
ggsave("../../out/image/131_UMAPCluster_res0.5_AST_subcluster.pdf",width = 4,height = 3)

DimPlot(data.combined, reduction = "umap",group.by = "RNA_snn_res.0.1",split.by = "origin",label = T,raster = T,ncol=4)
ggsave("../../out/image/131_UMAPCluster_splitTreat_res0.1_AST_subcluster.pdf",width = 6,height = 3)
...
ggsave(plot=test_long01,"../../out/image/131_DotplotLong_res0.1_AST_subcluster.pdf",width = 30,height = 5)
...
pdf("../../out/image/131_heatmap_signatureLong_res0.1_ASTsubset.pdf",width = 9,height = 4)
...
pdf("../../out/image/131_heatmap_signatureLong_res0.1_ASTsubset2.pdf",width = 8,height = 4)
...
sobj_total_h.markers %>%
  write_tsv("../../out/table/131_FindAllMarkers_HarmonySample_res0.1_AST_subcluster.tsv")

# pick the top 100 markers per cluster
sobj_total_h.markers %>%
  group_by(cluster) %>%
  dplyr::slice(1:100) %>%
  write_tsv("../../out/table/131_FindAllMarkers_HarmonySample_res0.1_AST_subcluster_top100.tsv")
...
sobj_total_h.markers %>%
  ...
  write_tsv("../../out/table/131_FindAllMarkers_HarmonySample_res0.1_AST_subcluster_top100_noRIBOandMT.tsv")
...
ggsave("../../out/image/131_Ditto_HarmonySample_res0.1_AST_subcluster.pdf",width = 15,height = 5)
