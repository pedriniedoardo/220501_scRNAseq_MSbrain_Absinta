...
df_tables_GSEA_all %>%
  write_tsv(paste0("../../out/table/146_df_table_GSEA_custom_ranklogfc_","ENDO",".tsv"))
...
# # save the table
# df_tables_GSEA_all_non_redundant %>%
#   write_tsv(file = paste0("../../out/table/23_df_table_GSEA_GOBP_nonredundant_ranklogfc_","ENDO",".tsv"))
...
# ggsave(paste0("../../out/image/23_GSEA_unbiased_GOBP_nonredundant_ranklogfc_","ENDO",".pdf"),width = 15,height = 15)
...
df_tables_GSEA_all %>%
  ...
  geom_text_repel(size = 2,box.padding = 0.5,segment.alpha = 0.6,max.overlaps = 10)+
  geom_hline(yintercept = -log(0.05),col="gray",linetype="dashed")
# ggsave(paste0("../../out/image/23_GSEA_unbiased_GOBP_ranklogfc_","ENDO",".pdf"),width = 15,height = 15)
...
wrap_plots(plot_pathway)
ggsave(filename = "../../out/image/146_GSEA_plot_profile_ENDO_shr_custom_rankLogFC.pdf",width = 10,height = 10)
