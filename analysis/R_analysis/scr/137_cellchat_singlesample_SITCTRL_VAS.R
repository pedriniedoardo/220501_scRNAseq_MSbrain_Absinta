...
seurat_GroupCTRL <- readRDS("../../out/object/revision/134_sobj_cellchat_SITCtrl_VAS.rds")
...
ggsave("../../out/image/revision/137_UMAP_seurat_GroupCTRLCellID_SIT_VAS.pdf",width = 6,height = 5)

DimPlot(seurat_GroupCTRL,label = F,split.by = "orig.ident",ncol = 3)+guides(colour = guide_legend(override.aes = list(size=5),ncol=1))
ggsave("../../out/image/revision/137_UMAP_seurat_GroupCTRLCellID_split_SIT_VAS.pdf",width = 10,height = 6)
...
df_summary %>%
  write_tsv("../../out/table/revision/137_prop_seurat_GroupCTRLCellID_SIT_VAS.tsv")
...
# ggsave("../../out/image/revision/137_CellChatDB.pdf",width = 5,height = 5)
...
pdf("../../out/image/revision/137_01_number_of_interactions_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 10)
...
pdf("../../out/image/revision/137_01_strength_of_interactions_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 10)
par(mfrow = c(1,1), xpd=TRUE)
...
pdf("../../out/image/revision/137_01_grid_interactions_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 15,height = 15)
par(mfrow = c(3,3), xpd=TRUE)
for (i in 1:nrow(mat)) {
  mat2 <- matrix(0, nrow = nrow(mat), ncol = ncol(mat), dimnames = dimnames(mat))
  mat2[i, ] <- mat[i, ]
...
pdf("../../out/image/revision/137_02_contribution_cellchat_GroupCTRL_SIT_VAS.pdf",width = 11,height = 11)
ht1 + ht2
dev.off()
...
gg1
ggsave("../../out/image/revision/137_02_contribution_all_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 5,height = 5)
...
gg2_SPP1
ggsave("../../out/image/revision/137_02_contribution_subset_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 5,height = 5)
# gg2_BMP
...
pdf("../../out/image/revision/137_02_contribution_hierarchy_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
...
vertex.receiver = seq(1,5) # a numeric vector. 
pdf("../../out/image/revision/137_02_contribution_chord_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
lapply(pathways.show, function(x){
...
#
vertex.receiver = seq(1,5) # a numeric vector. 
pdf("../../out/image/revision/137_02_contribution_circle_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
lapply(pathways.show, function(x){
...
# Heatmap
pdf("../../out/image/revision/137_02_contribution_heatmap_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
lapply(pathways.show, function(x){
...
ggsave("../../out/image/revision/137_02_contribution_braplotLR_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 5,height = 5)
...
# Hierarchy plot
vertex.receiver = seq(1,5) # a numeric vector
pdf("../../out/image/revision/137_02_contribution_hierarcyLR_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
...
dev.off()
#
pdf("../../out/image/revision/137_02_contribution_circleLR_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
lapply(pairLR$interaction_name, function(x){
...
dev.off()
#
pdf("../../out/image/revision/137_02_contribution_chordLR_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 10,height = 7)
lapply(pairLR$interaction_name, function(x){
...
pdf("../../out/image/revision/137_04_contribution_role_SPP1_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 5,height = 5)
...
ggsave("../../out/image/revision/137_selectK_outgoing_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 8,height = 4)
dev.off()
# Both Cophenetic and Silhouette values begin to drop suddenly when the number of outgoing patterns is 8.
nPatterns <- 4
pdf("../../out/image/revision/137_patterns_outgoing_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 15,height = 10)
...
ggsave("../../out/image/revision/137_river_outgoing_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 8,height = 10)
...
ggsave("../../out/image/revision/137_selectK_incoming_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 8,height = 4)
dev.off()
# siluette values begin to drop when the number of incoming patterns is 4.
nPatterns <- 5
pdf("../../out/image/revision/137_patterns_incoming_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 15,height = 10)
...
ggsave("../../out/image/revision/137_river_incoming_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 8,height = 10)
...
ggsave("../../out/image/revision/137_netVisual_functional_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 5,height = 5)
...
ggsave("../../out/image/revision/137_netVisual_structural_cellchat_GroupCTRLCellID_SIT_VAS.pdf",width = 5,height = 5)

# Part V: Save the CellChat object ----------------------------------------
saveRDS(cellchat_GroupCTRL, file = "../../out/object/revision/137_cellchat_GroupCTRLCellID_full_SIT_VAS.rds")
