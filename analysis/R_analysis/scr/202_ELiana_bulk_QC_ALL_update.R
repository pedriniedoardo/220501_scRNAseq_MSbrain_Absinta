...
# read in the data --------------------------------------------------------
ddsHTSeq <- readRDS("../../out/object/201_dds_all_update.rds")
...
ggsave("../../out/image/202_barplot_tot_count_all_update.pdf",width = 7,height = 5)
...
saveRDS(ddsHTSeq_filter,file = "../../out/object/202_dds_all_filter_update.rds")
...
ggsave(plot = meanSdPlot_vsd$gg+theme_bw(),filename = "../../out/image/202_meanSdPlot_vsd_all_update.pdf",width = 4,height = 4)

# save the object of interest ---------------------------------------------
saveRDS(vds,file = "../../out/object/vds_all_unfilter_update.rds")
saveRDS(vds_filter,file = "../../out/object/vds_all_filter_update.rds")


# plot cluster alternative ------------------------------------------------
# set seed to control random annotation colors
pdf("../../out/image/202_heatmap_clustering.pdf",width = 7,height = 5)
set.seed(2)
...
plot_vsd$data %>%
  ...
  geom_point(aes(col=Group,shape=sex),size =3) +
  ggrepel::geom_text_repel(show.legend = F)+
  scale_x_continuous(expand = expansion(mult = 0.1))+
  theme_bw() + ylab(plot_vsd$labels[1]) + xlab(plot_vsd$labels[2])
ggsave("../../out/image/202_PCA_vsd_colorGroup.pdf",width = 10,height = 8)
