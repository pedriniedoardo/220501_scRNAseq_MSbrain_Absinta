...
library(UpSetR)
pdf("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/upset_signatures_shortlist.pdf",width = 5,height = 4,onefile = F)
...
df_int %>%
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/upset_signatures_shortlist_intersection.tsv")
