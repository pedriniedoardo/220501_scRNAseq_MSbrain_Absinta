...
combined <- readRDS("../../out/object/data.combined_fix_filter_norm_doublet_integrated_SoupX.rds")
...
saveRDS(sobj_total_h,"../../out/object/data.combined_fix_filter_norm_doublet_integrated_SoupX_harmony.rds")
