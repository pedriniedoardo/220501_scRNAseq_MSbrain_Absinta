...
# DimPlot(scobj,raster = T,group.by = "RNA_snn_res.0.5",label = T)
# 
...
# saveRDS(ref_GEP,"../../out/object/207_ref_GEP_VAS_subcluster_res05.rds")

# read in the reference bulk dataset
ref_GEP <- readRDS("../../out/object/207_ref_GEP_VAS_subcluster_res05.rds")
...
saveRDS(bp_results,"../../out/object/207_bp_results_rawCount_VAS_sublsuter_res05_GEP.rds")
...
# save the table
write_tsv(df_theta,"../../out/table/207_theta_VAS_subcluster_res05_GEP.tsv")
...
ggsave(filename = "../../out/image/207_boxplot_theta_VAS_subcluster_res05_GEP.pdf",width = 5,height = 5)  
