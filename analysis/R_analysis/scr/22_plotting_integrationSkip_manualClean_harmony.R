...
scobj <- readRDS("../../out/object/ManualClean/data.combined_WM_CX_harmonySkipIntegration.rds")
...
df_meta_full %>%
  write_tsv("../../out/table/ManualClean/meta_data.combined_WM_CX_harmonySkipIntegration.tsv")
...
ggsave("../../out/image/ManualClean/UMAP_data.combined_WM_CX_harmonySkipIntegration.pdf",width = 8,height = 7)

DimPlot(scobj,label = T,raster = T,split.by = "orig.ident",ncol = 7)
ggsave("../../out/image/ManualClean/UMAP_data.combined_WM_CX_harmonySkipIntegration_splitSample.pdf",width = 29,height = 28)

DimPlot(scobj,label = T,raster = T,split.by = "origin")
ggsave("../../out/image/ManualClean/UMAP_data.combined_WM_CX_harmonySkipIntegration_origin.pdf",width = 15,height = 7)

DimPlot(scobj,label = T,raster = T,split.by = "origin",group.by = "seurat_clusters_ref")
...
df_summary <- scobj@meta.data %>% 
  ...
  ungroup() %>% 
  mutate(prop = n/tot)
write_tsv(df_summary,"../../out/table/ManualClean/df_summary_data.combined_WM_CX_harmonySkipIntegration.tsv")
...
ggsave("../../out/image/ManualClean/plot_summary_data.combined_WM_CX_harmonySkipIntegration_log.pdf",width = 8,height = 8)
...
ggsave("../../out/image/ManualClean/plot_summary_data.combined_WM_CX_harmonySkipIntegration_lin.pdf",width = 8,height = 8)
...
test_long2
ggsave("../../out/image/ManualClean/Dotplot_data.combined_WM_CX_harmonySkipIntegration.pdf",width = 23,height = 4)
