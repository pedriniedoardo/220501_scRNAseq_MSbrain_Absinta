# AIM ---------------------------------------------------------------------
# explore the expression of TSPO and FTL in the Absinta 2021 dataset, in particular the IMM subset
...
ggsave("../../out/image/00_density_plot_FTL_TSPO_Abisnta2021_IMM_UpdatePalette.pdf",width = 10,height = 4)
...
df_avg_wide %>%
  write_tsv("../../out/table/00_df_avg_wide_TSPO_FTL_Abisnta2021_IMM.tsv")
