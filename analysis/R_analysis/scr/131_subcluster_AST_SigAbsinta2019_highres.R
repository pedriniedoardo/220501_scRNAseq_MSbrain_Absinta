...
# ggsave("../../out/image/131_UMAP_SigAbsinta2019_ASTsubset.pdf",width = 25,height = 20)
...
df_senescence <- data.combined@meta.data %>%
  dplyr::select(RNA_snn_res.0.5,contains("score_")) %>%
...
mat_senescence_avg %>%
  ...
  write_tsv("../../out/table/131_tableScaled_SigAbisnta2019_res0.5_ASTsubset.tsv")

df_senescence %>%
  write_tsv("../../out/table/131_tableUnScaled_SigAbisnta2019_res0.5_ASTsubset.tsv")

pdf("../../out/image/131_heatmap_SigAbisnta2019_res0.5_ASTsubset.pdf",width = 10,height = 5)
...
pdf("../../out/image/131_heatmap_SigAbisnta2019_res0.5_ASTsubset_2.pdf",width = 10,height = 5)
