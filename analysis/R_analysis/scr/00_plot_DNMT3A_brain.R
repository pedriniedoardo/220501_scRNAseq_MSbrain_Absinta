# AIM ---------------------------------------------------------------------
# explore the expression of DNMT3A in the WM + CX dataset
...
df_tot %>%
  ...
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_DNMT3A_brain_count.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_DNMT3A_brain_count2.pdf",width = 6,height = 5)
...
ggsave("../../out/image/00_UMAPSeurat_annotationConfident_DNMT3A_brain_countNebulosa.pdf",width = 6,height = 5)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_DNMT3A_brain_count_alt.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_DNMT3A_brain_minmax.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_DNMT3A_brain_proppos.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_DNMT3A_brain_proppos2.pdf",width = 6,height = 5)
...
df_tot %>%
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("../../out/image/00_violin_annotationConfident_DNMT3A_brain.pdf",width = 15,height = 10)
...
df_avg |>
  ...
  facet_wrap(~expertAnno.l1,scales = "free")
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/00_dotplot_annotationConfident_DNMT3A_brain_expressionAvg_treat.pdf",width = 9,height = 9)
...
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/00_dotplot_annotationConfident_DNMT3A_brain_expressionAvg_treat_scale.pdf",width = 14,height = 3)
