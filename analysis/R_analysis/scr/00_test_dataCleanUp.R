...
# read in the data --------------------------------------------------------
scobj_all <- readRDS("../../out/object/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX.rds")
...
saveRDS(z.score.curated.by.cluster.all20,"../../out/object/00_test_dataCleanUP.rds")
