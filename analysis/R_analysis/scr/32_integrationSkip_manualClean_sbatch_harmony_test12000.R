...
folder <- "../../data/individual_samples/run_all_SoupX/"
...
saveRDS(sobj_total_h,"../../out/object/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_test12000.rds")
