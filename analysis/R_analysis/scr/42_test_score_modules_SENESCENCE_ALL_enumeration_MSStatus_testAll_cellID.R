...
# read in the data --------------------------------------------------------
folder <-  "../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/"
file <- dir(folder) %>% 
...
# save the table
df_en_090_final %>% 
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_ALL_090_threshold_MSStatus_refCX_cellID.tsv")
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_log2Prop_ALL_090_threshold_above5_MSStatus_CXref_cellID.pdf"),width = 18,height =20)
...
# save the table
enumeration_cellID %>% 
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_ALL_090_threshold_MSStatus_refCX_cellID_sampleWise.tsv")
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_log2Prop_ALL_090_threshold_above5_MSStatus_CXref_cellID_sampleWise.pdf"),width = 18,height =20)
...
enumeration_cellID %>%
  ...
  geom_point(position = position_jitter(width = 0.1)) +
  # geom_text_repel()+
  facet_wrap(signature~expertAnno.l1,scales = "free",ncol = 8)+
  theme_bw()+
  theme(strip.background = element_blank(),
        strip.text.y.right = element_text(angle = 0))+
  geom_hline(yintercept = 0.1,linetype="dotted",col="black")+theme(axis.text.x = element_text(hjust = 1,angle = 90))
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_log2Prop_ALL_090_threshold_above5_MSStatus_CXref_cellID_sampleWise_small2.pdf"),width = 18,height =15)
