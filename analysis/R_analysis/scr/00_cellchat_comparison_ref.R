...
# computeAveExpr(cellchat.CSF, features = c("NCAM1","NCAM2"), type =  "triMean")
...
#                     signaling = "VEGF")
#
# cellchat.CSF@var.features$features.info %>%
...
# pdf("../../out/image/comparison_09_L_R_pair_significant_OLIG_IN_DEG_chord_cellID.pdf",width = 20,height = 20)
...
test <- paste0(cellchat@meta$cellID,"_",cellchat@meta$datasets)
# add it to the metadata
cellchat@meta$test <- test

computeAveExpr(cellchat, features = c("Tgfa","Vegfa"),group.by = c("test"))
...
# pdf("../../out/image/comparison_09_pathway_significant_CSF_chord_OLIG_IN_cellID.pdf",width = 15,height = 15)
# list(
