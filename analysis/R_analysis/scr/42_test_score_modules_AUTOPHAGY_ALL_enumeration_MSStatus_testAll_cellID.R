...
# save the table
df_en_090_final %>% 
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_ALL_090_threshold_MSStatus_refCX_cellID_autophagy.tsv")
...
# save the table
enumeration_cellID %>% 
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_ALL_090_threshold_MSStatus_refCX_cellID_sampleWise_autophagy.tsv")
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_log2Prop_ALL_090_threshold_above5_MSStatus_CXref_cellID_sampleWise_autophagy.pdf"),width = 25,height =15)
...
enumeration_cellID %>%
  ...
  theme(strip.background = element_blank(),
        strip.text.y.right = element_text(angle = 0))+
  geom_hline(yintercept = 0.1,linetype="dotted",col="black")+theme(axis.text.x = element_text(hjust = 1,angle = 90))
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/enumeration_log2Prop_ALL_090_threshold_above5_MSStatus_CXref_cellID_sampleWise_small2_autophagy.pdf"),width = 25,height =20)
