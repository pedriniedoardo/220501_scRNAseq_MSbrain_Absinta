...
# read in the data --------------------------------------------------------
Seurat.object <- readRDS("../../out/object/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_test.rds")
...
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT.pdf",height = 10,width = 11)
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT.png",height = 10,width = 11)
...
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_split.pdf",height = 10,width = 41)
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_split.png",height = 10,width = 41)
...
write_tsv(df_summary_sample,"../../out/table/ManualClean/summary_SIT_sample.tsv")
...
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_propSample.pdf",height = 4,width = 8)
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_propSample.png",height = 4,width = 8)

# do the same per cluster
df_summary_cluster <- df_meta_full %>% 
  group_by(orig.ident,seurat_clusters,origin,pathology_class,SENEQUANTILE) %>% 
  summarise(n = n()) %>% 
  ungroup() %>% 
  group_by(orig.ident,seurat_clusters,origin,pathology_class) %>% 
  mutate(tot = sum(n)) %>% 
  ungroup() %>% 
  mutate(prop_senescence = n/tot)
write_tsv(df_summary_cluster,"../../out/table/ManualClean/summary_SIT_cluster.tsv")
...
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_propCluster.pdf",height = 12,width = 12)
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_propCluster.png",height = 12,width = 12)
...
df_summary_cellID <- df_meta_full %>% 
  group_by(orig.ident,cell_id,origin,pathology_class,SENEQUANTILE) %>% 
  summarise(n = n()) %>% 
  ungroup() %>% 
  group_by(orig.ident,cell_id,origin,pathology_class) %>% 
  mutate(tot = sum(n)) %>% 
  ungroup() %>% 
  mutate(prop_senescence = n/tot)
write_tsv(df_summary_cellID,"../../out/table/ManualClean/summary_SIT_cellID.tsv")
...
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_propCellID.pdf",height = 9,width = 9)
ggsave("../../out/image/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_SIT_propCellID.png",height = 9,width = 9)
...
df_meta_full %>%
  write_tsv("../../out/table/ManualClean/meta_SIT_WM_CX_harmonySkipIntegration_AllSoupX_test.tsv")
