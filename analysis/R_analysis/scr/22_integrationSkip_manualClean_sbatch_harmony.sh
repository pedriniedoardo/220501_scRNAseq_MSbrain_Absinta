...
#SBATCH --error="22_integrationSkip_SoupX_harmony.err"
#SBATCH --output="22_integrationSkip_SoupX_harmony.out"

echo "my job strart now" > 22_integrationSkip_SoupX_harmony.log;

date >> 22_integrationSkip_SoupX_harmony.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/22_integrationSkip_manualClean_sbatch_harmony.R

date >> 22_integrationSkip_SoupX_harmony.log;
echo "all done!!" >> 22_integrationSkip_SoupX_harmony.log