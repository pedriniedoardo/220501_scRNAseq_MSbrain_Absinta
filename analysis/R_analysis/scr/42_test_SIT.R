...
df_SIT <- read_tsv("../../out/table/ManualClean/meta_SIT_WM_CX_harmonySkipIntegration_AllSoupX_test.tsv")
...
enumeration_cellID %>% 
  write_tsv("../../out/table/ManualClean/enumeration_SIT_WM_CX_harmonySkipIntegAllSoupX_expertAnno.tsv")
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/enumeration_SIT_WM_CX_harmonySkipIntegAllSoupX_expertAnno.pdf"),width = 9,height =8)
...
df_SIT %>%
  ...
  theme(strip.background = element_blank())
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/UMAP_SIT_WM_CX_harmonySkipIntegAllSoupX_expertAnno.pdf"),width = 16,height = 4)
...
df_SIT %>%
  ...
  guides(color = guide_legend(override.aes = list(size=1,alpha=1)))+
  theme(strip.background = element_blank())
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/UMAP_SIT_WM_CX_harmonySkipIntegAllSoupX_expertAnno2.pdf"),width = 17,height = 4)
