# AIM ---------------------------------------------------------------------
# run the subcluster analysis for the MG cells from 
...
sobj_subset <- subset(sobj,subset = expertAnno.l1 %in% c("IMM","LYM"))
...
saveRDS(sobj_total_h,"../../out/object/129_MG_subcluster_HarmonySample.rds")
