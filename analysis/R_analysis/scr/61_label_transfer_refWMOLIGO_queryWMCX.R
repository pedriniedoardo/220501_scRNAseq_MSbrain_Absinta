...
ref_WM <- readRDS("../../data/all20_oligo_model.rds")
...
query <- readRDS("../../out/object/ManualClean/data.combined_WM_CX_OLIGO_harmonySkipIntegration.rds")
...
ggsave("../../out/image/histo_prediction_label_transfer_refWMOLIGO_queryWMCX.pdf",width = 5,height = 4)
...
ggsave("../../out/image/UMAP_label_transfer_refWMOLIGO_queryWMCX_raw.pdf",width = 5,height = 4)
...
ggplot(label= TRUE)+
  ...
  guides(colour = guide_legend(override.aes = list(size=5)))
ggsave("../../out/image/UMAP_label_transfer_refWMOLIGO_queryWMCX_robust.pdf",width = 5,height = 4)
...
ggsave("../../out/image/histo_label_transfer_refWMOLIGO_queryWMCX.pdf",width = 3,height = 4)
...
query_transfer@meta.data %>%
  ...
  theme_bw() +
  geom_vline(xintercept = 0.70,linetype="dashed",col="red",alpha=0.5)
ggsave("../../out/image/histo_label_transfer_refWMOLIGO_queryWMCX2.pdf",width = 3,height = 4)
...
pdf("../../out/image/heatmap_label_transfer_refWMOLIGO_queryWMCX_raw.pdf",height = 3,width = 3)
...
pdf("../../out/image/heatmap_label_transfer_refWMOLIGO_queryWMCX_robust.pdf",height = 3,width = 3)
...
UMAP_ref_WM$data %>%
  ...
  theme_cowplot()+
  guides(colour = guide_legend(override.aes = list(size=5)))
ggsave("../../out/image/UMAP_ref_WM_OLIGO.pdf",width = 6,height = 4)
...
UMAP_ref_WM$data %>%
  ...
  guides(colour = guide_legend(override.aes = list(size=5)))
ggsave("../../out/image/UMAP_ref_WM_OLIGO_no_lab.pdf",width = 4,height = 4)
...
ggsave("../../out/image/UMAP_label_transfer_refWMOLIGO_queryWMCX_raw_inverse.pdf",width = 6,height = 4)
...
ggplot(label= TRUE) +
  ...
  guides(colour = guide_legend(override.aes = list(size=5),ncol = 1))
ggsave("../../out/image/UMAP_label_transfer_refWMOLIGO_queryWMCX_robust_inverse.pdf",width = 6,height = 4)
...
ggplot(label= F) +
  ...
  guides(colour = guide_legend(override.aes = list(size=5),ncol = 1))+
  theme(legend.position = "none")
ggsave("../../out/image/UMAP_label_transfer_refWMOLIGO_queryWMCX_robust_inverse_no_lab.pdf",width = 5,height = 4)
