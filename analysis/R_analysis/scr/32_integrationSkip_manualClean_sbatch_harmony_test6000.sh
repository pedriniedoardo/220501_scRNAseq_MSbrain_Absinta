...
#SBATCH --error="32_integrationSkip_SoupX_harmony_test6000.err"
#SBATCH --output="32_integrationSkip_SoupX_harmony_test6000.out"

echo "my job strart now" > 32_integrationSkip_SoupX_harmony_test6000.log;

date >> 32_integrationSkip_SoupX_harmony_test6000.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/32_integrationSkip_manualClean_sbatch_harmony_test6000.R

date >> 32_integrationSkip_SoupX_harmony_test6000.log;
echo "all done!!" >> 32_integrationSkip_SoupX_harmony_test6000.log