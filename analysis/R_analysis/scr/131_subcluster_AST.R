...
sobj_subset <- subset(sobj,subset = expertAnno.l1 %in% c("AST"))
...
DimPlot(sobj_total_h,raster = T,group.by = "origin",label = T)
...
saveRDS(sobj_total_h,"../../out/object/131_AST_subcluster_HarmonySample.rds")
