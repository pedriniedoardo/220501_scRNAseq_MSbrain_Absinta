...
# saveRDS(ref_GEP,"../../out/object/207_ref_GEP.rds")

# read in the reference bulk dataset
ref_GEP <- readRDS("../../out/object/207_ref_GEP.rds")
...
saveRDS(bp_results,"../../out/object/207_bp_results_rawCount_expertAnno.l1_GEP.rds")
...
# save the table
write_tsv(df_theta,"../../out/table/207_theta_expertAnno.l1_GEP.tsv")
...
ggsave(filename = "../../out/image/207_boxplot_theta_expertAnno.l1_GEP.pdf",width = 5,height = 5)  
