...
#SBATCH --error="12_harmony_SoupX_ManualClean.err"
#SBATCH --output="12_harmony_SoupX_ManualClean.out"

echo "my job strart now" > 12_harmony_SoupX_ManualClean.log;

date >> 12_harmony_SoupX_ManualClean.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/12_integration_manualClean_sbatch_harmony.R

date >> 12_harmony_SoupX_ManualClean.log;
echo "all done!!" >> 12_harmony_SoupX_ManualClean.log