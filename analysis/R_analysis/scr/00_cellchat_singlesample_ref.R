...
# cellchat_GroupCSFCellID <- readRDS("out/cellchat_GroupCSFCellID_full.rds")
...
# cellchat_GroupCSFCellID <- computeCommunProb(cellchat_GroupCSFCellID)
# cellchat_GroupCSFCellID <- computeCommunProb(cellchat_GroupCSFCellID,trim = 0)
# cellchat_GroupCSFCellID <- computeCommunProb(cellchat_GroupCSFCellID,do.fast = T,seed.use = 44)
...
# pdf("images/01_grid_interactions_cellchat_GroupCSFCellID.pdf",width = 10,height = 10)
...
# gg2_PTN <- netAnalysis_signalingRole_scatter(cellchat_GroupCSFCellID, signaling = c("PTN"))
# gg2 <- netAnalysis_signalingRole_scatter(cellchat_GroupCSFCellID, signaling = c("VISFATIN"))
# gg3 <- netAnalysis_signalingRole_scatter(cellchat_GroupCSFCellID, signaling = c("SPP1"))
# gg4 <- netAnalysis_signalingRole_scatter(cellchat_GroupCSFCellID, signaling = c("PSAP"))

gg2_SPP1
ggsave("../../out/image/02_contribution_subset_SPP1_cellchat_GroupCSFCellID.pdf",width = 5,height = 5)
# gg2_BMP
# ggsave("out/image/02_contribution_subset_BMP_cellchat_GroupCSFCellID.pdf",width = 5,height = 5)
...
# levels(cellchat_GroupCSFCellID@idents)
# netVisual_bubble(cellchat_GroupCSFCellID, sources.use = 14, targets.use = c(1:20), remove.isolate = FALSE)
# ggsave("out/image/03_contribution_bubble_from_IMM_LR_cellchat_GroupCSFCellID.pdf",width = 6,height = 6)
# 
# # look at what comes into OLIG
# levels(cellchat_GroupCSFCellID@idents)
# netVisual_bubble(cellchat_GroupCSFCellID, sources.use = c(1:20), targets.use = c(11,18), remove.isolate = FALSE)
# ggsave("out/image/03_contribution_bubble_to_OLIG_LR_cellchat_GroupCSFCellID.pdf",width = 10,height = 10)
# 
# # show all the significant interactions (L-R pairs) from some cell groups (defined by 'sources.use') to other cell groups (defined by 'targets.use')
# # show all the interactions sending from Inflam.FIB
# pdf("out/image/03_contribution_circle_from_IMM_LR_cellchat_GroupCSFCellID.pdf",width = 12,height = 12)
# netVisual_chord_gene(cellchat_GroupCSFCellID, sources.use = 13, targets.use = c(1:20), lab.cex = 0.5,legend.pos.y = 30)
# dev.off()
# 
# pdf("out/image/03_contribution_circle_to_OLIG_LR_cellchat_GroupCSFCellID.pdf",width = 12,height = 12)
# netVisual_chord_gene(cellchat_GroupCSFCellID, sources.use = c(1:20), targets.use = c(11,18), lab.cex = 0.5,legend.pos.y = 30)
# dev.off()
