...
list_sig <- readRDS("../../data/signatures/autophagy_pathways.rds")
...
lapply(names(list_sig),function(x){
  ...
  df_meta %>% 
    write_tsv(paste0("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/Module_score_",x,".tsv"))
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,".pdf"),width = 18,height = 3)
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,".png"),width = 18,height = 3)
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_2.pdf"),width = 10,height = 3)
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_2.png"),width = 10,height = 3)
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_split_",x,".pdf"),width = 20,height = 20)
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_split_",x,".png"),width = 20,height = 20)
  ...
  # ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/dist_score_",x,"_2.pdf"),width = 12,height =9)
  ...
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/dist_score_ridges_",x,"_2.pdf"),width = 12,height =9)
  ...
  # ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/violin_score_split_",x,".pdf"),width = 25,height = 9)
  ...
  data2 %>%
    ...
    # scale_fill_manual(values = c("green","yellow","red"))+
    theme(strip.background = element_blank(),axis.text.x = element_text(hjust = 1,angle = 90))
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/violin_score_",x,".pdf"),width = 9,height = 9)
})

# tailored plotting -------------------------------------------------------
x <- "GOBP_REGULATION_OF_AUTOPHAGY"
...
data2 <- left_join(df_UMAP,df_meta,"barcode")
data2_avg <- data2 %>% group_by(seurat_clusters) %>% dplyr::select(UMAP_1, UMAP_2) %>% summarize_all(mean)
data2_avg2 <- data2 %>% group_by(expertAnno.l1) %>% dplyr::select(UMAP_1, UMAP_2) %>% summarize_all(mean)
...
# scale_color_gradientn(colours = viridis::turbo(10))
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored1.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored1.png"),width = 11,height = 10)
...
data2 %>%
  ...
  # mutate(gene = "Ptx3") %>%
  ggplot() + geom_point(aes(x = UMAP_1, y = UMAP_2,col = signature_score1),alpha = 0.5,size = 0.2) +
  geom_text_repel(data = data2_avg2,aes(x = UMAP_1, y = UMAP_2,label = expertAnno.l1)) +
  facet_wrap(~pathology_class,nrow = 3) + theme_void() + 
  theme(strip.background = element_blank()) +
  scale_color_gradientn("sig score",
                        colours = c("gray","orange","red"),
...
# scale_color_gradientn(colours = c("gray","yellow","red"))
# scale_color_gradientn(colours = viridis::turbo(10))
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored1_2.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored1_2.png"),width = 11,height = 10)
...
# scale_color_gradientn(colours = c("gray","yellow","red"))
# scale_color_gradientn(colours = viridis::turbo(10))
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored1_3.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored1_3.png"),width = 11,height = 10)
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored2.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored2.png"),width = 11,height = 10)
...
data2 %>%
  ...
  scale_color_gradientn("sig score",
                        colours = viridis::turbo(10),limits = c(-0.1,0.3),oob = scales::squish)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored2_2.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored2_2.png"),width = 11,height = 10)
...
data2 %>%
  ...
  scale_color_gradientn("sig score",
                        colours = viridis::turbo(10),limits = c(-0.1,0.3),oob = scales::squish)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored2_3.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/UMAP_score_",x,"_tailored2_3.png"),width = 11,height = 10)
...
library(UpSetR)
pdf("../../out/image/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/upset_signatures_shortlist_authophagy.pdf",width = 10,height = 6,onefile = F)
...
df_int %>%
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/HVG4000_expertAnno/upset_signatures_shortlist_intersection_autophagy.tsv")
