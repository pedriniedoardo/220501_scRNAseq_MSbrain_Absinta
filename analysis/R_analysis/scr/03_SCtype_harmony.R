...
ggsave("../../out/image/UMAP_data.combined_fix_filter_norm_doublet_integrated_SoupX_harmony_SCType.pdf",width = 10,height = 7)

# save the annotated object -----------------------------------------------
saveRDS(scobj,"../out_large/scRNAseq_analysis/object/sobj_total_h_fix_filter_norm_doublet_harmony_5K_scaleSbatch_SCtypeAnnotation.rds")
