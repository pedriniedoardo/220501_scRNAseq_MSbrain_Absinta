...
#SBATCH --error="32_integrationSkip_SoupX_harmony.err"
#SBATCH --output="32_integrationSkip_SoupX_harmony.out"

echo "my job strart now" > 32_integrationSkip_SoupX_harmony.log;

date >> 32_integrationSkip_SoupX_harmony.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/32_integrationSkip_manualClean_sbatch_harmony.R

date >> 32_integrationSkip_SoupX_harmony.log;
echo "all done!!" >> 32_integrationSkip_SoupX_harmony.log