# AIM ---------------------------------------------------------------------
# try to run the subclustering of the NEU cluster from the total object.
# the idea is to see if we can pop out potentially low quality oligo from the neurons.
...
test <- subset(scobj,subset = seurat_clusters %in% c(1,2,6,7,8,10))
...
saveRDS(sobj_total_h,"../../out/object/revision/100_subcluster_NEU.rds")
