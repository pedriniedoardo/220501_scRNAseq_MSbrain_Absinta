# AIM ---------------------------------------------------------------------
# explore the expression of DPP3 in the WM + CX dataset
...
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/00_dotplot_annotationConfident_DPP3_expressionAvg_treat_scale.pdf",width = 14,height = 3)
