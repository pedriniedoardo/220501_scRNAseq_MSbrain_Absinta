...
df_tables_GSEA_all %>%
  write_tsv(paste0("../../out/table/202_df_table_GSEA_REACTOME_ranklogfc_","MS",".tsv"))
...
# save the table
df_tables_GSEA_all_non_redundant %>%
  write_tsv(file = paste0("../../out/table/202_df_table_GSEA_REACTOME_nonredundant_ranklogfc_","MS",".tsv"))
...
ggsave(paste0("../../out/image/202_GSEA_unbiased_REACTOME_nonredundant_ranklogfc_","MS",".pdf"),width = 15,height = 15)
...
df_tables_GSEA_all %>%
  ...
  geom_text_repel(size = 2,box.padding = 0.5,segment.alpha = 0.6,max.overlaps = 10)+
  geom_hline(yintercept = -log(0.05),col="gray",linetype="dashed")
ggsave(paste0("../../out/image/202_GSEA_unbiased_REACTOME_ranklogfc_","MS",".pdf"),width = 15,height = 15)
