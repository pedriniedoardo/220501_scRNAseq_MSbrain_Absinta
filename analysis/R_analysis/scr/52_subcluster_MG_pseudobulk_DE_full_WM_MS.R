...
saveRDS(counts_MG,file = "../../out/object/counts_MG_WM.rds")
saveRDS(colData_MG,file = "../../out/object/colData_MG_WM.rds")
...
# save the disign
saveRDS(design_MG,"../../out/object/design_MG_WM.rds")
...
pdf("../../out/image/heatmap_SampleCluster_pseudobulk_MG_WM.pdf",width = 10,height = 6)
set.seed(3)
...
plot_vsd_MG$data %>%
  ...
  scale_x_continuous(expand = expansion(mult = 0.1))+
  theme_bw() + ylab(plot_vsd_MG$labels[1]) + xlab(plot_vsd_MG$labels[2])
ggsave("../../out/image/PCA_pseudobulk_MG_WM.pdf",width = 6,height = 4)
...
pdf("../../out/image/heatmap_cellType_pseudobulk_MG_WM.pdf",width = 7,height = 5)
...
pdf("../../out/image/heatmap_cellType_pseudobulk_MG_WM2.pdf",width = 7,height = 5)
...
saveRDS(ddsHTSeq_MG_filter,"../../out/object/ddsHTSeq_pseudobulk_MG_WM.rds")
...
# save the table
df_res %>%
  write_tsv("../../out/table/DE_pseudobulk_MG_WM.tsv")
...
# save the table
df_res_shr %>%
  write_tsv("../../out/table/DE_pseudobulk_MG_WM_shr.tsv")
...
ggsave("../../out/image/histogram_pvalue_pseudobulk_MG_WM.pdf",width = 6,height = 4)
...
pdf("../../out/image/heatmap_DEG_plot_pseudobulk_MG_WM_shr.pdf",width = 7,height = 14)
...
pdf("../../out/image/heatmap_DEG_plot_pseudobulk_MG_WM.pdf",width = 7,height = 14)
draw(ht2_shr_MG2,heatmap_legend_side = "left",annotation_legend_side = "left",padding = unit(c(30,2,2, 2), "mm"))
dev.off()
