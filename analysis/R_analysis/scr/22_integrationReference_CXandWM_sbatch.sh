...
#SBATCH --error="22_integrationReference_SoupX.err"
#SBATCH --output="22_integrationReference_SoupX.out"

echo "my job strart now" > 22_integrationReference_SoupX.log;

date >> 22_integrationReference_SoupX.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/22_integrationReference_CXandWM_sbatch.R

date >> 22_integrationReference_SoupX.log;
echo "all done!!" >> 22_integrationReference_SoupX.log