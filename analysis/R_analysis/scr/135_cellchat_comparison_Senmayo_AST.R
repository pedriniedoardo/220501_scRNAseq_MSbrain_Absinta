...
cellchat.CTRL <- readRDS("../../out/object/revision/133_cellchat_GroupCTRLCellID_full_AST.rds")
cellchat.SEN <- readRDS("../../out/object/revision/133_cellchat_GroupSENCellID_full_AST.rds")
...
gg1 + gg2
ggsave("../../out/image/revision/135_comparison_01_barplot_interaction_cellID_AST.pdf",width = 10,height = 5)
...
# pdf("../../out/image/revision/135_comparison_02_differential_interaction_cellID.pdf",width = 20,height = 10)
# par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/135_comparison_02_differential_interaction_cellID_AST.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/135_comparison_02_differential_interaction_cellID_AST_high.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
list(netVisual_diffInteraction(cellchat, weight.scale = T),
     netVisual_diffInteraction(cellchat, weight.scale = T, measure = "weight"))
dev.off()
...
pdf("../../out/image/revision/135_comparison_02_differential_interaction_cellID_AST_high2.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/135_comparison_02_differential_interaction_UP_cellID_AST.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/135_comparison_02_differential_interaction_DOWN_cellID_AST.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/135_comparison_02_differential_interaction_heatmap_cellID_AST.pdf",width = 10,height = 5)
gg1 + gg2
dev.off()
...
pdf("../../out/image/revision/135_comparison_03_interaction_individual_number_cellID_AST.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/135_comparison_03_interaction_individual_strenght_cellID_AST.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
lapply(1:length(object.list),function(i){
...
pdf("../../out/image/revision/135_comparison_04_compare_source_target_cellID_AST.pdf",width = 10,height = 5)
...
pdf("../../out/image/revision/135_comparison_05_compare_signalling_cellID_AST.pdf",width = 30,height = 15)
...
pdf("../../out/image/revision/135_comparison_05_compare_signalling_cellID2_AST.pdf",width = 12,height = 10)
...
# Visualization in 2D-space
pdf("../../out/image/revision/135_comparison_05_structural_similarity_cellID_AST.pdf",width = 10,height = 9)
netVisual_embeddingPairwise(cellchat, type = "structural", label.size = 3.5)
dev.off()

pdf("../../out/image/revision/135_comparison_05_structural_similarity_grid_cellID_AST.pdf",width = 10,height = 9)
...
pdf("../../out/image/revision/135_comparison_06_rank_similarity_cellID_AST.pdf",width = 5,height = 5)
...
pdf("../../out/image/revision/135_comparison_07_signaling_pathway_comparison_cellID_AST.pdf",width = 10,height = 8)
gg1 + gg2
dev.off()
...
pdf("../../out/image/revision/135_comparison_08_signaling_pathway_comparison_outgoing_cellID_AST.pdf",width = 10,height = 10)
...
pdf("../../out/image/revision/135_comparison_08_signaling_pathway_comparison_incoming_cellID_AST.pdf",width = 10,height = 10)
draw(ht1 + ht2, ht_gap = unit(1, "cm"))
dev.off()
...
pdf("../../out/image/revision/135_comparison_08_signaling_pathway_comparison_overall_cellID_AST.pdf",width = 10,height = 10)
draw(ht1 + ht2, ht_gap = unit(1, "cm"))
dev.off()
...
pdf("../../out/image/revision/135_comparison_09_L_R_pair_significant_ALL_cellID_AST.pdf",width = 40,height = 30)
gg1 + gg2
dev.off()
#
...
net.up %>% 
  write_tsv("../../out/table/revision/135_net.up_cellID_SEN_AST.tsv")
# net.up %>%
#   filter(ligand == "Vegfa")
...
pdf("../../out/image/revision/135_comparison_09_L_R_pair_significant_DEG_cellID_AST.pdf",width = 20,height = 8)
# gg1 + gg2
gg1
dev.off()
...
# pdf("../../out/image/revision/135_comparison_09_L_R_pair_significant_OLIG_IN_DEG_chord_cellID.pdf",width = 20,height = 20)
...
mat_test_general <- computeAveExpr(cellchat, features = unique(c(unique(net.up$ligand),unique(net.up$receptor))),group.by = c("expertAnno.l1")) %>%
  .[,c("IMM","EPENDYMA","EXC NEU","INH NEU","LYM","OLIGO","OPC","VAS")]

# add the avg expression for imm senescent and control
mat_test_update <- left_join(mat_test %>% data.frame() %>% select("AST_CTRL","AST_SEN") %>% rownames_to_column("gene"),
                             mat_test_general %>% data.frame() %>% rownames_to_column("gene"),by = "gene") %>%
  column_to_rownames("gene")


pdf("../../out/image/revision/135_comparison_09_L_R_pair_significant_DEG_cellID_heatmap_avgExp_AST.pdf",width = 6,height = 7)
...
# add the avg expression for imm senescent and control
mat_test_ligand_update <- left_join(mat_test_ligand %>% data.frame() %>% select("AST_CTRL","AST_SEN") %>% rownames_to_column("gene"),
                                    mat_test_ligand_general %>% data.frame() %>% rownames_to_column("gene"),by = "gene") %>%
  column_to_rownames("gene")

mat_test_receptor_update <- left_join(mat_test_receptor %>% data.frame() %>% select("AST_CTRL","AST_SEN") %>% rownames_to_column("gene"),
...
pdf("../../out/image/revision/135_comparison_09_L_R_pair_significant_DEG_cellID_heatmap_scaledExp_AST.pdf",width = 6,height = 7)
...
pdf("../../out/image/revision/135_comparison_09_pathway_significant_CSF_chord_cellID_AST.pdf",width = 15,height = 15)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'netP',
                       net = net.up, lab.cex = 0.8, small.gap = 3.5,
...
# pdf("../../out/image/revision/135_comparison_09_pathway_significant_CSF_chord_OLIG_IN_cellID.pdf",width = 15,height = 15)
# list(
...
# plot all the LR
pdf("../../out/image/revision/135_comparison_09_LR_significant_CSF_chord_cellID_AST.pdf",width = 15,height = 15)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'net',
                       net = net.up, lab.cex = 0.8, small.gap = 3.5,
...
pdf("../../out/image/revision/135_comparison_09_LR_significant_CSF_chord_cellID_high_AST.pdf",width = 10,height = 10)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'net',
...
pdf("../../out/image/revision/135_comparison_09_LR_significant_CSF_chord_cellID_high2_AST.pdf",width = 7,height = 7)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'net',
...
saveRDS(cellchat, file = "../../out/object/cellchat_comparison_CTRL_vs_CSF_cellID_AST.rds")
