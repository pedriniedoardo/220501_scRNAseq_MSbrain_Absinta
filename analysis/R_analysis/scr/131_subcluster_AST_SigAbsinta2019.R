...
mat_senescence_avg %>%
  ...
  write_tsv("../../out/table/131_tableScaled_SigAbisnta2019_res0.1_ASTsubset.tsv")

df_senescence %>%
  write_tsv("../../out/table/131_tableUnScaled_SigAbisnta2019_res0.1_ASTsubset.tsv")

pdf("../../out/image/131_heatmap_SigAbisnta2019_res0.1_ASTsubset.pdf",width = 10,height = 5)
...
pdf("../../out/image/131_heatmap_SigAbisnta2019_res0.1_ASTsubset_2.pdf",width = 10,height = 5)
