...
# in this case use the Yang GEP profile subcluster profile
...
ref_GEP <- readRDS("../../data/HuVascAD.ALL.GEP.cellid.rds")
...
saveRDS(bp_results,"../../out/object/207_bp_results_rawCount_YangALL_sublsuter_GEP.rds")
...
# save the table
write_tsv(df_theta,"../../out/table/207_theta_YangALL_subcluster_GEP.tsv")
