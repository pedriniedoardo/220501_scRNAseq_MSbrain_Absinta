# AIM ---------------------------------------------------------------------
# explore the expression of MGLL in the WM + CX dataset
...
df_tot %>%
  ...
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MGLL_count.pdf",width = 13,height = 12)

# do the same using Seurat
FeaturePlot(data.combined,features = GOI,split.by = "pathology_class",raster = T,order = T,ncol = 3)
# ggsave("../../out/image/06_UMAPSeurat_annotationConfident_MGLL_count.pdf",width = 25,height = 3)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MGLL_count2.pdf",width = 6,height = 5)

# do the same using Seurat
FeaturePlot(data.combined,features = GOI,raster = T,order = T)
# ggsave("../../out/image/06_UMAPSeurat_annotationConfident_MGLL_count.pdf",width = 6,height = 5)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MGLL_count_alt.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MGLL_minmax.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MGLL_proppos.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MGLL_proppos2.pdf",width = 6,height = 5)
...
df_tot %>%
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("../../out/image/00_violin_annotationConfident_MGLL.pdf",width = 15,height = 10)
...
# ggsave("../../out/image/06_dotplot_annotationConfident_MGLL_expressionAvg_treatFull.pdf",width = 9,height = 9)
...
df_avg |>
  ...
  facet_wrap(~expertAnno.l1,scales = "free")
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/00_dotplot_annotationConfident_MGLL_expressionAvg_treat.pdf",width = 9,height = 9)
...
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/00_dotplot_annotationConfident_MGLL_expressionAvg_treat_scale.pdf",width = 14,height = 3)
