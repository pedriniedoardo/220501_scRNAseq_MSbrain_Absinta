# AIM ---------------------------------------------------------------------
# explore the expression of GLP1R in the WM + CX dataset
...
df_tot %>%
  ...
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_GLP1R_count.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_GLP1R_count2.pdf",width = 6,height = 5)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_GLP1R_count_alt.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_GLP1R_minmax.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_GLP1R_proppos.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_GLP1R_proppos2.pdf",width = 6,height = 5)
...
df_tot %>%
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("../../out/image/00_violin_annotationConfident_GLP1R.pdf",width = 15,height = 10)
