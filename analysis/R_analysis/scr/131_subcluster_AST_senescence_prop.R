...
(DimPlot(data.combined,group.by = "RNA_snn_res.0.5") + ggtitle("Harmony Sample"))
...
df_meta_full %>%
  ...
  ungroup() %>%
  mutate(RNA_snn_res.0.1 = fct_reorder(RNA_snn_res.0.1,-avg_prop)) %>%
  write_tsv("../../out/table/131_prop_res0.1_senescence_AST.tsv")
...
df_meta_full %>%
  ...
  ungroup() %>%
  mutate(RNA_snn_res.0.1 = fct_reorder(RNA_snn_res.0.1,-avg_prop)) %>%
  write_tsv("../../out/table/131_prop_res0.1_senescence_sample_AST.tsv")
...
df_meta_full %>%
  ...
  mutate(prop = n_cluster/n_tot_sample) %>%
  mutate(RNA_snn_res.0.1 = fct_reorder(RNA_snn_res.0.1,prop)) %>%
  write_tsv("../../out/table/131_prop_res0.1_AST.tsv")
...
df_meta_full %>%
  ...
  mutate(prop = n_cluster/n_tot_sample) %>%
  mutate(RNA_snn_res.0.1 = fct_reorder(RNA_snn_res.0.1,prop)) %>%
  write_tsv("../../out/table/131_prop_res0.1_AST_originDisease.tsv")
...
df_meta_full %>%
  ...
  mutate(prop = n_cluster/n_tot_sample) %>%
  mutate(RNA_snn_res.0.1 = fct_reorder(RNA_snn_res.0.1,prop)) %>%
  write_tsv("../../out/table/131_prop_res0.1_AST_includeZeros.tsv")
...
df_meta_full %>%
  ...
  mutate(prop = n_cluster/n_tot_sample) %>%
  mutate(RNA_snn_res.0.1 = fct_reorder(RNA_snn_res.0.1,prop)) %>%
  write_tsv("../../out/table/131_prop_res0.1_AST_originDisease_includeZeros.tsv")
