...
ggsave("../../out/image/ManualClean/UMAP_data.combined_WM_CX_harmonySkipIntegration_SCType.pdf",width = 10,height = 7)

# save the annotated object -----------------------------------------------
saveRDS(scobj,"../../out/object/ManualClean/data.combined_WM_CX_harmonySkipIntegration_SCtypeAnnotation.rds")
