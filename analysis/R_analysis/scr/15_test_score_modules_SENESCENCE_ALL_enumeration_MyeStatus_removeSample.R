...
df_en_090_final %>%
  write_tsv("../../out/table/ManualClean/modules_SENESCENCE/enumeration_senmayo_090_threshold_MyeStatus_removeSample.tsv")
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/dist_score_ridges_senmayo_090_threshold_MyeStatus_removeSample.pdf"),width = 12,height =9)
...
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/enumeration_log2Prop_senmayo_090_threshold_above5_MyeStatus_removeSample.pdf"),width = 12,height =9)
