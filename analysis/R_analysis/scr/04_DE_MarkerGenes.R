...
sobj_total_h.markers %>%
  write_tsv("../../out/table/FindAllMarkers_fix_filter_norm_doublet_integrated_SoupX_harmony_PosOnly.tsv")
...
sobj_total_h.markers %>%
  ...
  filter(rank < 101) %>%
  write_tsv("../../out/table/FindAllMarkers_fix_filter_norm_doublet_integrated_SoupX_harmony_PosOnly_top100.tsv")
...
df_avg_exp %>% 
  write_tsv("../../out/table/AvgExp_fix_filter_norm_doublet_integrated_SoupX_harmony_SeuratClusters.tsv")
