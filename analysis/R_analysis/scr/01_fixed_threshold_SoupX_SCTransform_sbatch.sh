...
#SBATCH --error="01_fixed_threshold_SoupX_SCTransform_sbatch.err"
#SBATCH --output="01_fixed_threshold_SoupX_SCTransform_sbatch.out"

echo "my job strart now" > 01_fixed_threshold_SoupX_SCTransform_sbatch.log;

date >> 01_fixed_threshold_SoupX_SCTransform_sbatch.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/01_fixed_threshold_SoupX_SCTransform_sbatch.R

date >> 01_fixed_threshold_SoupX_SCTransform_sbatch.log;
echo "all done!!" >> 01_fixed_threshold_SoupX_SCTransform_sbatch.log