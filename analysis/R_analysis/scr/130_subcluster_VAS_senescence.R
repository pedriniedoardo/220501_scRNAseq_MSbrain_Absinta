...
ggsave("../../out/image/130_UMAP_senescence_VASsubset.pdf",width = 25,height = 20)
...
pdf("../../out/image/130_heatmap_senescence_res0.1_VASsubset.pdf",width = 9,height = 5)
...
df_senescence2 <- data.combined@meta.data %>%
  dplyr::select(RNA_snn_res.0.4,contains("scoreSen_")) %>%
...
pdf("../../out/image/130_heatmap_senescence_res0.4_VASsubset_highres.pdf",width = 10,height = 5)
