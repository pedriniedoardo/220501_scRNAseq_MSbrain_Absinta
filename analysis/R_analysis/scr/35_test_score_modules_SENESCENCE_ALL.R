...
# read the data -----------------------------------------------------------
# read in the dataset
data.combined <- readRDS("../../out/object/ManualClean/data.combined_WM_CX_harmonySkipIntegration_AllSoupX_test.rds")
...
lapply(names(list_sig),function(x){
  ...
  df_meta %>% 
    write_tsv(paste0("../../out/table/ManualClean/modules_SENESCENCE/HVG4000/Module_score_",x,".tsv"))
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000/UMAP_score_",x,".pdf"),width = 18,height = 3)
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000/UMAP_score_",x,".png"),width = 18,height = 3)
  ...
  data2 %>%
    ...
    # scale_fill_manual(values = c("green","yellow","red"))+
    theme(strip.background = element_blank(),axis.text.x = element_text(hjust = 1,angle = 90))
  ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000/violin_score_",x,".pdf"),width = 9,height = 9)
})
...
data2 %>%
  ...
  # scale_color_gradientn(colours = viridis::turbo(10))
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000/UMAP_score_",x,"_tailored1.pdf"),width = 11,height = 10)
ggsave(paste0("../../out/image/ManualClean/modules_SENESCENCE/HVG4000/UMAP_score_",x,"_tailored1.png"),width = 11,height = 10)
