# AIM ---------------------------------------------------------------------
# explore the expression of MS4A in the Absinta 2021 dataset, in particular the IMM subset
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/00_UMAPggplot_annotationConfident_MS4A_Abisnta2021_count2.pdf",width = 13,height = 9)
...
ggsave("../../out/image/00_density_plot_MS4A_Abisnta2021_IMM.pdf",width = 13,height = 9)
...
ggsave("../../out/image/00_boxplot_cluster_AvgExp_MS4A_Abisnta2021_IMM.pdf",width = 12,height = 8)
...
df_avg |>
  ...
  facet_wrap(~gene,scales = "free") +
  scale_y_continuous(trans = "log1p")
ggsave("../../out/image/00_boxplot_treat_AvgExp_MS4A_Abisnta2021_IMM.pdf",width = 8,height = 10)
...
ggsave("../../out/image/00_boxplot_TreatCluster_AvgExp_MS4A_Abisnta2021_IMM.pdf",width = 10,height = 12)
...
ggsave(plot = test_long01,"../../out/image/00_dotplot_cluster_MS4A_Abisnta2021_IMM.pdf",width = 5,height = 5)
