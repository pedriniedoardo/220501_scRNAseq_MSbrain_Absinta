...
#SBATCH --error="02_integration_SoupX.err"
#SBATCH --output="02_integration_SoupX.out"

echo "my job strart now" > 02_integration_SoupX.log;

date >> 02_integration_SoupX.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/02_integration_sbatch.R

date >> 02_integration_SoupX.log;
echo "all done!!" >> 02_integration_SoupX.log