...
cellchat.CTRL <- readRDS("../../out/object/revision/137_cellchat_GroupCTRLCellID_full_SIT_VAS.rds")
cellchat.SEN <- readRDS("../../out/object/revision/137_cellchat_GroupSENCellID_full_SIT_VAS.rds")
...
gg1 + gg2
ggsave("../../out/image/revision/138_comparison_01_barplot_interaction_cellID_SIT_VAS.pdf",width = 10,height = 5)
...
# pdf("../../out/image/revision/138_comparison_02_differential_interaction_cellID.pdf",width = 20,height = 10)
# par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/138_comparison_02_differential_interaction_cellID_SIT_VAS.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/138_comparison_02_differential_interaction_UP_cellID_SIT_VAS.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/138_comparison_02_differential_interaction_DOWN_cellID_SIT_VAS.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/138_comparison_02_differential_interaction_cellID_SIT_VAS_high.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
list(netVisual_diffInteraction(cellchat, weight.scale = T),
     netVisual_diffInteraction(cellchat, weight.scale = T, measure = "weight"))
dev.off()

netVisual_diffInteraction(cellchat, weight.scale = T,edge.width.max = 20,label.edge = T)

pdf("../../out/image/revision/138_comparison_02_differential_interaction_cellID_SIT_VAS_high2.pdf",width = 10,height = 5)
par(mfrow = c(1,2), xpd=TRUE)
list(netVisual_diffInteraction(cellchat, weight.scale = T,edge.width.max = 20,vertex.label.cex = 0.01))
dev.off()
...
pdf("../../out/image/revision/138_comparison_02_differential_interaction_heatmap_cellID_SIT_VAS.pdf",width = 10,height = 5)
gg1 + gg2
dev.off()
...
pdf("../../out/image/revision/138_comparison_03_interaction_individual_number_cellID_SIT_VAS.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
...
pdf("../../out/image/revision/138_comparison_03_interaction_individual_strenght_cellID_SIT_VAS.pdf",width = 20,height = 10)
par(mfrow = c(1,2), xpd=TRUE)
lapply(1:length(object.list),function(i){
...
pdf("../../out/image/revision/138_comparison_04_compare_source_target_cellID_SIT_VAS.pdf",width = 10,height = 5)
...
pdf("../../out/image/revision/138_comparison_05_compare_signalling_cellID_SIT_VAS.pdf",width = 30,height = 15)
...
pdf("../../out/image/revision/138_comparison_05_compare_signalling_cellID2_SIT_VAS.pdf",width = 12,height = 10)
...
# Visualization in 2D-space
pdf("../../out/image/revision/138_comparison_05_structural_similarity_cellID_SIT_VAS.pdf",width = 10,height = 9)
netVisual_embeddingPairwise(cellchat, type = "structural", label.size = 3.5)
dev.off()

pdf("../../out/image/revision/138_comparison_05_structural_similarity_grid_cellID_SIT_VAS.pdf",width = 10,height = 9)
...
pdf("../../out/image/revision/138_comparison_06_rank_similarity_cellID_SIT_VAS.pdf",width = 5,height = 5)
...
pdf("../../out/image/revision/138_comparison_07_signaling_pathway_comparison_cellID_SIT_VAS.pdf",width = 10,height = 8)
gg1 + gg2
dev.off()
...
pdf("../../out/image/revision/138_comparison_08_signaling_pathway_comparison_outgoing_cellID_SIT_VAS.pdf",width = 10,height = 10)
...
pdf("../../out/image/revision/138_comparison_08_signaling_pathway_comparison_incoming_cellID_SIT_VAS.pdf",width = 10,height = 10)
draw(ht1 + ht2, ht_gap = unit(1, "cm"))
dev.off()
...
pdf("../../out/image/revision/138_comparison_08_signaling_pathway_comparison_overall_cellID_SIT_VAS.pdf",width = 10,height = 10)
draw(ht1 + ht2, ht_gap = unit(1, "cm"))
dev.off()
...
pdf("../../out/image/revision/138_comparison_09_L_R_pair_significant_ALL_cellID_SIT_VAS.pdf",width = 30,height = 15)
gg1 + gg2
dev.off()
#
...
net.up %>% 
  write_tsv("../../out/table/revision/138_net.up_cellID_SEN_SIT_VAS.tsv")
# net.up %>%
#   filter(ligand == "Vegfa")
...
pdf("../../out/image/revision/138_comparison_09_L_R_pair_significant_DEG_cellID_SIT_VAS.pdf",width = 20,height = 8)
# gg1 + gg2
gg1
dev.off()
...
# pdf("../../out/image/revision/138_comparison_09_L_R_pair_significant_OLIG_IN_DEG_chord_cellID.pdf",width = 20,height = 20)
...
mat_test_general <- computeAveExpr(cellchat, features = unique(c(unique(net.up$ligand),unique(net.up$receptor))),group.by = c("expertAnno.l1")) %>%
  .[,c("AST","EPENDYMA","EXC NEU","INH NEU","LYM","OLIGO","OPC","IMM")]

# add the avg expression for imm senescent and control
mat_test_update <- left_join(mat_test %>% data.frame() %>% select("VAS_CTRL","VAS_SEN") %>% rownames_to_column("gene"),
                             mat_test_general %>% data.frame() %>% rownames_to_column("gene"),by = "gene") %>%
  column_to_rownames("gene")


pdf("../../out/image/revision/138_comparison_09_L_R_pair_significant_DEG_cellID_heatmap_avgExp_SIT_VAS.pdf",width = 6,height = 5)
...
# Martina suggested to generate the matrices for the other cell types not split by senescence or control. remove the IMM.
mat_test_ligand_general <- computeAveExpr(cellchat, features = unique(net.up$ligand),group.by = c("expertAnno.l1")) %>%
  .[,c("IMM","EPENDYMA","EXC NEU","INH NEU","LYM","OLIGO","OPC","AST")]
...
# add the avg expression for imm senescent and control
mat_test_ligand_update <- left_join(mat_test_ligand %>% data.frame() %>% select("VAS_CTRL","VAS_SEN") %>% rownames_to_column("gene"),
                                    mat_test_ligand_general %>% data.frame() %>% rownames_to_column("gene"),by = "gene") %>%
  column_to_rownames("gene")

mat_test_receptor_update <- left_join(mat_test_receptor %>% data.frame() %>% select("VAS_CTRL","VAS_SEN") %>% rownames_to_column("gene"),
                                      mat_test_receptor_general %>% data.frame() %>% rownames_to_column("gene"),by = "gene") %>%
  column_to_rownames("gene")
...
pdf("../../out/image/revision/138_comparison_09_L_R_pair_significant_DEG_cellID_heatmap_scaledExp_SIT_VAS.pdf",width = 6,height = 6)
...
pdf("../../out/image/revision/138_comparison_09_pathway_significant_CSF_chord_cellID_SIT_VAS.pdf",width = 15,height = 15)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'netP',
                       net = net.up, lab.cex = 0.8, small.gap = 3.5,
...
# pdf("../../out/image/revision/138_comparison_09_pathway_significant_CSF_chord_OLIG_IN_cellID.pdf",width = 15,height = 15)
# list(
...
# plot all the LR
pdf("../../out/image/revision/138_comparison_09_LR_significant_CSF_chord_cellID_SIT_VAS.pdf",width = 15,height = 15)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'net',
                       net = net.up, lab.cex = 0.8, small.gap = 3.5,
...
pdf("../../out/image/revision/138_comparison_09_LR_significant_CSF_chord_cellID_SIT_high_VAS.pdf",width = 10,height = 10)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'net',
                       net = net.up, lab.cex = 0.7, small.gap = 0.01,
                       title.name = paste0("Up-regulated signaling in ", names(object.list)[2]))
  # netVisual_chord_gene2(object.list[[1]],
  #                       slot.name = 'net',
  #                       net = net.down, lab.cex = 0.8, small.gap = 3.5,
...
pdf("../../out/image/revision/138_comparison_09_LR_significant_CSF_chord_cellID_SIT_high2_VAS.pdf",width = 8,height = 8)
list(
  netVisual_chord_gene(object.list[[2]],
                       slot.name = 'net',
                       net = net.up, lab.cex = 0.8, small.gap = 1,big.gap = 1,scale = T,
                       title.name = paste0("Up-regulated signaling in ", names(object.list)[2]))
  # netVisual_chord_gene2(object.list[[1]],
  #                       slot.name = 'net',
  #                       net = net.down, lab.cex = 0.8, small.gap = 3.5,
...
saveRDS(cellchat, file = "../../out/object/cellchat_comparison_CTRL_vs_CSF_cellID_SIT_VAS.rds")
