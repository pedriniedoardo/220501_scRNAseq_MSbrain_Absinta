...
#SBATCH --error="00_test_dataCleanUp.err"
#SBATCH --output="00_test_dataCleanUp.out"

echo "my job strart now" > 00_test_dataCleanUp.log;

date >> 00_test_dataCleanUp.log;

. /home/pedrini.edoardo/miniconda3/bin/activate;
conda activate env_R4.2_renv;

Rscript /home/pedrini.edoardo/scr/project_edoardo/220501_scRNAseq_MSbrain_Absinta/R_analysis/scr/00_test_dataCleanUp.R

date >> 00_test_dataCleanUp.log;
echo "all done!!" >> 00_test_dataCleanUp.log