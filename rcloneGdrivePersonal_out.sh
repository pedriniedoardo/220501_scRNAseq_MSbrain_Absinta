...
rclone copy -PL /beegfs/scratch/ric.cosr/pedrini.edoardo/project_edoardo/220501_scRNAseq_MSbrain_Absinta/out \
gdrive_edo:work/analysis/HSR/absinta/scrnaseq/220501_scRNAseq_MSbrain_Absinta/out
